...
<div class="hero-section">
    <div class="hero-content">
        ...
        <a href="#" class="button buzzer-default-btn">ADD A SONG</a>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <ul class="hero-footer-list">
              <li>
                <span>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/audio_file.svg" 
                      alt="audio file" 
                      class="decoration decoration-top-left">Up to 3min sound
                </span>
              </li>
              <li>
                <span>
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/audio_file.svg" 
                      alt="audio file" 
                      class="decoration decoration-top-left">
                  Up to 3min sound
                </span>
              </li>
              <li>
