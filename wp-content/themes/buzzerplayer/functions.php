...
function my_custom_block_render_callback( $attributes, $content ) {
    ...
    ?>
    <div class="my-custom-block-container">
        <h2><?php echo esc_html( $attributes['title'] ); ?></h2>
        <p><?php echo esc_html( $attributes['description'] ); ?></p>
        <div class="custom-html-output">
            <p>This is a custom HTML element that will not be in the editor.111</p>
            <p>You can add any PHP or HTML here.</p>
            <a href="#">Learn More</a>
        </div>
    </div>
    <?php
...
function my_custom_block_init() {
    register_block_type( 'my-custom-block/faq', array(
